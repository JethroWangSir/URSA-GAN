...
def save_audio(opt, visuals_list, img_path):
    ...
    for visual in visuals_list:
        ...
        im = im.resize((opt.fix_w, 129), Image.LANCZOS)
    ...
    data, sr = getTimeSeries(spec, img_path, opt.spec_power, opt.fix_w, opt.energy, state = opt.state)
...
if __name__ == '__main__':
    ...
    print(f'Source {opt.source_idx} is done!')